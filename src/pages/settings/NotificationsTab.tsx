    ...
    <>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-slate-100 p-4 flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <span className="font-semibold text-slate-900">Notification Preferences</span>
        </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-slate-100 overflow-hidden">
        ...
        {([
          ...
          { key: 'sms' as const,         Icon: MessageSquare, iconBg: 'bg-slate-100 text-slate-600',    title: 'SMS Reminders',           desc: 'Follow-up reminders via SMS'            },
          ...
          <div key={item.key} className="flex items-center justify-between p-4 border-b border-slate-50 last:border-0 hover:bg-slate-50 transition-colors">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-slate-100 overflow-hidden">
        <div className="px-6 py-4 border-b border-slate-100">
          <h3 className="text-sm font-semibold text-slate-900">Alert Triggers</h3>
        </div>
        ...
        <div className="flex items-center justify-between p-4 border-b border-slate-50 hover:bg-slate-50 transition-colors">
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="text-sm font-medium text-slate-800">HOT Lead Alert</p>
              <p className="text-xs text-slate-500">Instant alert when lead becomes HOT</p>
            </div>
          </div>
        ...
        <div className="flex items-center justify-between p-4 border-b border-slate-50 hover:bg-slate-50 transition-colors">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500">Reminder before follow-up due</p>
            </div>
          </div>
