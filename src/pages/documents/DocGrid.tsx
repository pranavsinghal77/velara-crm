      ...
      {filteredDocs.length === 0 ? (
        ...
        <div className="grid grid-cols-3 gap-4">
          {filteredDocs.map((doc) => (
            <div key={doc.id} className="bg-white rounded-xl shadow-sm border border-slate-100 p-4 flex flex-col gap-2">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-slate-400 truncate">{doc.leadName}</p>
